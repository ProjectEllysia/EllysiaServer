...
.btn-new { display: inline-flex; align-items: center; gap: 0.35rem; height: 32px; padding: 0 0.85rem; margin-bottom: 0.85rem; background: var(--accent-dim); border: 1px solid var(--accent); color: var(--accent-bright); font-weight: 600; font-size: var(--fs-lg); border-radius: 6px; cursor: pointer; transition: all 0.2s; }
...
.field input, .field select { padding: 0.45rem 0.6rem; background: var(--surface-3); border: 1px solid var(--border-solid); border-radius: 6px; color: var(--text); font-size: var(--fs-input); outline: none; transition: border-color 0.2s; }
...
.btn-create { height: 32px; padding: 0 1.1rem; background: var(--accent); border: 1px solid var(--accent-bright); color: var(--on-accent); font-weight: 600; font-size: var(--fs-lg); border-radius: 6px; cursor: pointer; display: inline-flex; align-items: center; justify-content: center; gap: 0.35rem; transition: opacity 0.2s; margin-top: 0.2rem; min-width: 64px; }
.btn-create:hover:not(:disabled) { opacity: 0.85; }
.btn-create:disabled { opacity: 0.4; cursor: not-allowed; }
.btn-spin { width: 13px; height: 13px; border: 2px solid rgba(0,0,0,0.2); border-top-color: var(--on-accent); border-radius: 50%; animation: seq-spin 0.6s linear infinite; display: inline-block; }
.scheduled-loading, .scheduled-empty { display: flex; align-items: center; justify-content: center; gap: 0.4rem; padding: 2rem 1rem; color: var(--text-muted); font-size: var(--fs-lg); }
...
.scheduled-table th { text-align: left; padding: 0.5rem 0.55rem; font-size: var(--fs-md); text-transform: uppercase; letter-spacing: 0.04em; color: var(--text-muted); font-weight: 600; background: var(--surface-2); }
